...
-- một transaction phải được thực hiện toàn bộ hoặc hủy toàn bộ.
-- hệ thống hiện tại đã trừ tiền nhưng chưa giảm công nợ,
-- tạo trạng thái dữ liệu không nhất quánn
